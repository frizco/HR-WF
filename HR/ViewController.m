...
@interface ViewController () <WFHardwareConnectorDelegate,WFSensorConnectionDelegate>
...
- (void) updateData
{
    ...
    if([self.sensorConnection isKindOfClass:[WFHeartrateConnection class]])
    {
        ...
        {
            isValid=YES;
            self.searialLabel.text = hrConnection.deviceIDString;
